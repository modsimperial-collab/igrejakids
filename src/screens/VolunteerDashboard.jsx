...
export default function VolunteerDashboard({ user }) {
  ...
  // Estado para lista de presenças do dia e modal de ficha da criança
  ...
  // Assinatura em tempo real das presenças do dia
  useEffect(() => {
  ...
  // Buscar estatísticas de frequência para cada filho na lista
  useEffect(() => {
  ...
  // Lista de crianças com entrada ativa hoje (último registro do dia foi 'entrada')
  ...
  // Filtragem de crianças por busca
  ...
  return (
    <div className="vol-container">
      ...
      {/* ABA 2: CRIANÇAS EM PRESENÇA / SUPERVISÃO (HOJE) */}
      {activeTab === 'criancas' && (
                        ...
                        <div style={{ minWidth: 0 }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', flexWrap: 'wrap' }}>
                            ...
                            {child?.neurodivergente && (
                              ...
                              >
                                {child.neurodivergencia_detalhe || 'tda'}
                              </span>
                            )}
                            {child?.alergias && (
                              <span style={{ 
